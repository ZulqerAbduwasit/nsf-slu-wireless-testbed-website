    ...
    <> 
      <div className='publications-main-container'>
        <p className="firstp">
          ...
          , 2022. 
          <br /><br />[
          <a href="https://ieeexplore.ieee.org/document/9974927" target="_blank" rel="noopener noreferrer">
            paper
          </a>
          ] [
          <button onClick={()=>setFirstButtonPopup(true)}>
            bibtex
          </button>
          ] [
          <a href="https://github.com/pintauroo/5G_LMF" target="_blank" rel="noopener noreferrer">
            code
          </a>
          ]
        </p>
        ...
        <p className="secondp">
          S. S. Bhavanasi, L. Pappone, and F. Esposito,
          ...
          , 2023. 
          <br /><br />[
          <a href="https://ieeexplore.ieee.org/document/10158424" target="_blank" rel="noopener noreferrer">
            paper
          </a>
          ] [
          <button onClick={()=>setSecondButtonPopup(true)}>
            bibtex
          </button>
          ]
        </p>  
        ...
        <p className="thirdp">
          C. Puligheddu, J. Ashdown, C. F. Chiasserini, and F. Restuccia,
          <br />"SEM-O-RAN: Semantic and Flexible O-RAN Slicing for NextG Edge-Assisted Mobile Systems”,
          <br />
          <span>  
            Proc. of IEEE  Conference on Computer Communications (IEEE INFOCOM)
          </span>
          , Hoboken, New Jersey, United States, May 2023.  
          <br /><br />[
          <a href="https://arxiv.org/abs/2212.11853" target="_blank" rel="noopener noreferrer">
            paper
          </a>
          ] [
          <button onClick={()=>setThirdButtonPopup(true)}>
            bibtex
          </button>]
        </p>  
        ...
        <p className="fourthp">
          ...
          , 2022.  
          <br /><br />[
          <a href="https://ieeexplore.ieee.org/document/9974607" target="_blank" rel="noopener noreferrer">
            paper
          </a>
          ] [
          <button onClick={()=>setFourthButtonPopup(true)}>
            bibtex
          </button>
          ]   
        </p>     
